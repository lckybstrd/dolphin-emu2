...
public:
  ...
  public:
    ...
    inline ScopedARM64Reg(ScopedARM64Reg&& scopedReg) { *this = std::move(scopedReg); }
    ...
    inline ScopedARM64Reg& operator=(ScopedARM64Reg&& scopedReg)
    {
      // Taking ownership of an existing scoped register, no need to release.
      m_reg = scopedReg.m_reg;
      m_gpr = scopedReg.m_gpr;
      scopedReg.Invalidate();
      return *this;
    }
